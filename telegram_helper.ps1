# XArchiver Build Telegram Helper v2.0
...
switch ($Action) {
    ...
    "update" {
        ...
        $msg = "[BUILD] XArchiver $BuildType`n"
        $msg += "`n====================`n"
        $msg += "Stage: $Stage`n"
        $msg += "[$bar] $Progress%`n"
    ...
    "success" {
        ...
        $msg = "[SUCCESS] XArchiver $BuildType Build Complete!`n"
        $msg += "`n====================`n"
        $msg += "[####################] 100%`n"
        $msg += "====================`n"
        $msg += "`nAPK ready!`n"
    ...
    "failed" {
        $msg = "[FAILED] XArchiver $BuildType Build`n"
        $msg += "`n====================`n"
